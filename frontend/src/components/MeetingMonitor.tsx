...
const MeetingMonitor: React.FC<Props> = ({ meetingId, onMeetingEnd }) => {
  ...
  const handleEndMeeting = async () => {
    if (
      !confirm(
        "Are you sure you want to end the meeting? This will stop the bot and generate the spec."
      )
    )
      return;
      ...
      <div className="card-header d-flex justify-content-between align-items-center bg-white">
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="d-flex gap-2">
            <button className="btn btn-primary" onClick={toggleMonitoring}>
              Summon Bot
            </button>
          ...
          transcripts.map((t, idx) => (
            <div key={t.id || idx} className="mb-3">
              <div className="small text-muted mb-1">
                ...
                - <span className="fw-bold text-primary">{t.speaker}</span>
              </div>
